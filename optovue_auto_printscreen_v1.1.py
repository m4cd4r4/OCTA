...
This script automates the tedius task of screengrabbing each slice of a 304-slice volume
...
v1.1 - Replaced "GadWin" with pyautogui's built-in screenshot function
"""
